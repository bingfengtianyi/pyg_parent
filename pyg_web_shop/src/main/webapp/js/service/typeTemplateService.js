...
app.service('typeTemplateService',function($http){
	...
	this.findPage=function(page,rows){
		return $http.get('../typeTemplate/findPage.action?pageNum='+page+'&pageSize='+rows);
	}
	//查询实体
	...
	this.search=function(page,rows,searchEntity){
		return $http.post('../typeTemplate/search.action?pageNum='+page+"&pageSize="+rows, searchEntity);
	}    	
