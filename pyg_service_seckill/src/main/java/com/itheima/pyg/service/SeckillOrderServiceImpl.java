...
import com.itheima.pyg.pojo.seckill.SeckillOrderQuery;
...
public class SeckillOrderServiceImpl implements SeckillOrderService {
     ...
     */
    @Override
    public List<SeckillOrder> findSeckillOrderListFromDB() {
        List<SeckillOrder> seckillOrderList = seckillOrderDao.selectByExample(new SeckillOrderQuery());
